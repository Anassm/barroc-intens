      ...
      <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
          ...
          <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <div class="flex">
              <a href="/contact"><button class="flex ml-auto hover:text-gray-800 text-white bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-400 rounded">Offerte aanvragen</button></a>
