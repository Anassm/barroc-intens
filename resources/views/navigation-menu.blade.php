    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
        <div class="flex justify-between h-16">
            ...
            @endphp
                ...
                @include('components.menuinkoop')
                @endif
                @if($teamid == 5)
                
                @include('components.menumaintenance')
                @endif
                @if($teamid == 2)
               @include('components.menufinance')
                @endif
               
               @if($teamid == 3)
               @include('components.menusales')
               @endif
                    ...
                    <div class="ml-3 relative">
                        <x-jet-dropdown align="right" width="60">
                            ...
                            <x-slot name="content">
                                <div class="w-60">
                                    <!-- Team Management -->
                                    <div class="block px-4 py-2 text-xs text-amber-300">
                                        {{ __('Manage Team') }}
                                    </div>
                    ...
                    <x-jet-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="flex text-sm border-2 border-transparent rounded-full focus:outline-none focus:border-gray-800 transition">
